...
*/
var ActivityEngine=function(a){if(!a.menu)a.menu=new ContextMenu(this,[{className:"start-event",action:"StartEvent",text:"\u5f00\u59cb\u4e8b\u4ef6"},{className:"end-event",action:"EndEvent",text:"\u7ed3\u675f\u4e8b\u4ef6"},{className:"timer",action:"TimerEvent",text:"\u8ba1\u65f6\u5668\u4e8b\u4ef6"},{className:"user-task",action:"UserTask",text:"\u7528\u6237\u4efb\u52a1"},{className:"script-task",action:"ScriptTask",text:"\u811a\u672c\u4efb\u52a1"},{className:"parallel-gateway",action:"ParallelGateway",
text:"\u5e73\u884c\u7f51\u5173"},{className:"connection",action:"",text:"\u8fde\u63a5\u7ebf"},{className:"sp",action:"",text:""},{className:"subprocess",action:"SubProcess",text:"\u5b50\u6d41\u7a0b"},{className:"sp",action:"",text:""},{className:"delete",action:"",text:"\u5220\u9664"}]);ActivityEngine.superClass.constructor.call(this,a)};Q.inherit(ActivityEngine,Engine);ActivityEngine.prototype.addUserTask=function(a,b){return this._addAcitivty("UserTask",a,b)};
ActivityEngine.prototype.addServiceTask=function(a,b){return this._addAcitivty("ServiceTask",a,b)};ActivityEngine.prototype.addScriptTask=function(a,b){return this._addAcitivty("ScriptTask",a,b)};ActivityEngine.prototype.addSubProcess=function(a,b){return this._addAcitivty("SubProcess",a,b)};ActivityEngine.prototype.addParallelGateway=function(a,b){return this._addAcitivty("ParallelGateway",a,b)};
...
ActivityEngine.prototype.addShadowFlow=function(a,b,c){a||(a={});a.connectionCreated=function(a){a.id=Quark.UIDUtil.createUID("sequenceFlow");a.rawType="SequenceFlow"};ActivityEngine.superClass.addShadowFlow.call(this,a,b,c)};ActivityEngine.prototype.addSequenceFlow=function(a){var b={x:0,y:0,autoSize:!0};Q.merge(b,a);b=SequenceFlow.create(b);a.startNode&&a.startNode.parent.addChild(b);return b};
...
ServiceTask.prototype.rawObject=function(){return{resourceId:this.id,properties:{asynchronousdefinition:this.raw.asynchronousdefinition||"No",documentation:this.raw.documentation||"",duedatedefinition:this.raw.dueDate,exclusivedefinition:this.raw.exclusiveDefinition||"Yes",formkeydefinition:this.raw.formKey||"",formproperties:{totalCount:this.raw.formItems?this.raw.formItems.length:0,items:this.raw.formItems?this.raw.formItems:[]},isforcompensation:this.raw.isforcompensation||"false",looptype:this.raw.looptype||
"None",name:this.name,prioritydefinition:this.raw.prioritydefinition,tasklisteners:this.raw.taskListeners||{},usertaskassignment:{items:this.raw.userTaskAssignment?this.raw.userTaskAssignment:[],totalCount:this.raw.userTaskAssignment?this.raw.userTaskAssignment.length:0},executionlisteners:this.raw.executionlisteners||{},servicetaskclass:"",servicetaskexpression:"",servicetaskdelegateexpression:"",servicetaskresultvariable:this.raw.serviceTaskResultVariable||"resultVariable",servicetaskfields:{items:this.raw.serviceTaskFields?
...
e.raw.usertaskassignment.items.length,e.raw.formkeydefinition=d.formKey,e.raw.exclusivedefinition=!d.notExclusive,e.raw.asynchronousdefinition=d.asynchronous,e.raw.duedatedefinition=d.dueDate,e.raw.prioritydefinition=d.priority;else if(i==="TimerEvent")h.push({node:e,element:d});else if(i==="StartEvent")e.raw.formkeydefinition=d.formKey,e.raw.initiator=d.initiator;if(typeof d.formProperties!="undefined"&&d.formProperties.length>0)for(k in e.raw.formproperties={totalCount:d.formProperties.length,items:[]},
d.formProperties)i=d.formProperties[k],e.raw.formproperties.items.push({formproperty_id:parseInt(i.id)?parseInt(i.id):i.id,formproperty_name:i.name,formproperty_type:"",formproperty_expression:"",formproperty_variable:""});d.flowElements&&d.flowElements.length>0&&this.convert(d,b,c,e)}}for(g=0;g<h.length;g++)h[g].node.raw.cancelactivity=h[g].element.cancelActivity,h[g].node.raw.timerdurationdefinition=h[g].element.eventDefinitions[0].timeDuration,h[g].node.raw.timerdatedefinition=h[g].element.eventDefinitions[0].timeDate,
h[g].node.raw.timercycledefinition=h[g].element.eventDefinitions[0].timeCycle,h[g].element.attachedToRef&&h[g].element.attachedToRefId&&(d=c.byId(h[g].element.attachedToRefId))&&h[g].node._dock(d);for(g=0;g<a.flowElements.length;g++)if(d=a.flowElements[g],e=b.flowLocationMap[d.id]){f=h=null;k=[];d.sourceRef&&(h=c.byId(d.sourceRef));d.targetRef&&(f=c.byId(d.targetRef));for(i=0;i<e.length;i++)k.push({x:e[i].x,y:e[i].y});if(h&&f)e=c.addSequenceFlow({startNode:h,endNode:f,points:k,id:d.id},j),e.condition=
d.conditionExpression,e.raw.conditionsequenceflow=d.conditionExpression,e.raw.documentation=d.documentation,e.raw.name=d.name,e.name=d.name,e.isDefault=e.id===e.startNode.raw.defaultFlow}}},convertRoot:function(a,b){a.raw.process_id=b.mainProcess.id;a.raw.process_namespace=b.targetNamespace||"http://www.activiti.org/processdef";a.raw.name=b.mainProcess.name||"";a.raw.documentation=b.mainProcess.documentation||"";a.raw.candidateStarterUsers=b.mainProcess.candidateStarterUsers||"";a.raw.candidateStarterGroups=
b.mainProcess.candidateStarterGroups||"";var c=a.raw.candidateStarterUsers;if(Ext.isArray(c)&&c.length>0)a.raw.candidateStarterUsers=c.join(",");c=a.raw.candidateStarterGroups;!Ext.isArray(c)&&typeof c==="string"&&(c=c.split(","));if(c&&c.length>0){for(var f=[],j=0;j<c.length;j++)isNaN(parseInt(c[j]))||f.push(parseInt(c[j]));a.raw.candidateStarterGroups=f}},load:function(a,b){var c={};if(typeof b.processDefinitionId!="undefined"&&b.processDefinitionId!=null)c.processDefinitionId=b.processDefinitionId;
else if(typeof b.deploymentId!="undefined"&&b.deploymentId!=null)c.deploymentId=b.deploymentId;else if(typeof b.key!="undefined"&&b.key!=null)c.key=b.key;else if(typeof b.processInstanceId!="undefined"&&b.processInstanceId!=null)c.processInstanceId=b.processInstanceId;else{alert("\u6ca1\u6709\u8db3\u591f\u7684\u53c2\u6570\uff01");return}var f=this;Ext.Ajax.request({url:b.queryUrl,params:c,method:"GET",success:function(c){c=Ext.decode(c.responseText,!0);!c||c.msg?Utils.isFunction(b.loadFailed)&&b.loadFailed(c):
(a.clear(),new ActivityAdapter,f.convert(c.mainProcess,c,a),Utils.isFunction(b.loadSuccess)&&(f.convertRoot(a,c),b.loadSuccess(c)))},failure:function(a){Utils.isFunction(b.loadFailed)&&b.loadFailed(a)}})}};
