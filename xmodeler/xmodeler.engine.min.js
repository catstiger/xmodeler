...
!1;this.active=a.active;this.resizable=!0;this.resizeDirect="default";this.resizing=!1;this.icon=this.border=this.mouseY=this.mouseX=null;this.textColor="#333333";Q.merge(this,a);this.baseType="task";this.width=a.width||120;this.height=a.height||60;this.textAlign="middle";this.iconAlign="left";this.fillColor=a.fillColor;this.dockedItems=[];this.nameBindingInput=null;this.nameInputShowing=!1};Q.inherit(AbstractActivity,BoxObject);
...
offsetY:b});return!1})}}else c=this.getStage().context.canvas.getContext("2d").measureText(this.name).width,this.namePainter.clear(),b=0,!this.textAlign||this.textAlign=="middle"?b=this.height/2+4:this.textAlign=="top"&&(b=14),this.namePainter._addAction(["font","12px serif"])._addAction(["fillStyle",this.error?"#ff0000":this.textColor])._addAction(["fillText",this.name,this.width/2-c/2-3,b])};
...
a.endNode;this._destinations();this.arrowH=12;this.arrowW=8;this.painter=new Q.Graphics;this.addChild(this.painter);this.condition=null;this.draging=!1;this.dragingPoint=null;this.selected=!1;this.baseType="connection";this.canBeConnected=!1;this.lineColor="#111111"};Q.inherit(AbstractConnection,Element);
AbstractConnection.prototype.update=function(){this.points&&!(this.points.length<=0)&&(this._destinations(),this.painter.clear(),this.selected?(this._calcMiddle(),this._drawSelector()):this._drawBasic(this._isDefault()?"#D9442F":this.lineColor),this._drawText())};AbstractConnection.prototype.onMouseDown=function(a){if(Utils.isLeft(a)){var b=Utils.epos(a),b=this.hitTest(b.x,b.y);if(this.selected&&b)this.draging=b;this.selected=b;a.cancelBubble=b}};
